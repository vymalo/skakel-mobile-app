...
class ProductApi {
  ...
  ///
  /// Parameters:
  /// * [productInfo] - Product details for adding the product
  ...
  Future<Response<Product>> addProduct({ 
    ...
    try {
      const _type = FullType(ProductInfo);
      _bodyData = productInfo == null ? null : _serializers.serialize(productInfo, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [category] - Category of the products (e.g., electronics, clothing)
