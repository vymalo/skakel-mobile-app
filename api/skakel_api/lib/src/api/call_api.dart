...
import 'package:skakel_api/src/api_util.dart';
...
class CallApi {
  ...
  const CallApi(this._dio, this._serializers);
  ...
  Future<Response<void>> endCall({ 
    ...
    final _path = r'/calls/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  ///
  /// Parameters:
  /// * [userId] - ID of the user associated with the calls
  /// * [callType] - Type of calls (e.g., Video, Audio)
  /// * [startTime] - Start time for filtering calls (format yyyy-mm-ddTHH:mm:ssZ)
  /// * [endTime] - End time for filtering calls (format yyyy-mm-ddTHH:mm:ssZ)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<BuiltList<Call>>> getCallsByQuery({ 
    ...
    return Response<BuiltList<Call>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [call] - Call object that needs to be initiated
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Call] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Call>> initiateCall({ 
    Call? call,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(Call);
      _bodyData = call == null ? null : _serializers.serialize(call, specifiedType: _type);
  ...
  /// Parameters:
  /// * [id] 
  /// * [user] - User object that needs to be invited as a participant
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<Call>> inviteParticipantToCall({ 
    ...
    final _path = r'/calls/{id}/participants'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> removeParticipantFromCall({ 
    ...
    final _path = r'/calls/{id}/participants/{userId}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
