...
class PaymentApi {
  ...
  Future<Response<PaymentTransaction>> cancelPaymentTransaction({ 
    ...
    final _path = r'/payment/transactions/{id}/cancel'.replaceAll('{' r'id' '}', id.toString());
    ...
    PaymentTransaction? _responseData;
  ...
  Future<Response<PaymentTransaction>> confirmPaymentTransaction({ 
    ...
    final _path = r'/payment/transactions/{id}/confirm'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PaymentTransaction>> getPaymentTransactionById({ 
    ...
    final _path = r'/payment/transactions/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PaymentTransaction>> initiatePaymentTransaction({ 
    ...
    final _path = r'/payment/transactions';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
